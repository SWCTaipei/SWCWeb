...
<body>
        ...
        <div class="header-wrap-s">
            <div class="header header-s clearfix"><a href="SWC001.aspx" class="logo-s"></a>
                ...
                <ul>
                    ...
                    <asp:Panel ID="GOVMG" runat="server" Visible="false"><li>|&nbsp&nbsp&nbsp&nbsp<a href="../SWCTCGOV/SWCGOV001.aspx" title="系統管理">系統管理</a></li></asp:Panel>
                    <li>|</li>
   ...
   <span >通知對象：</span>
    ...
    <span>事件名稱:</span><input type="text" /><br>
