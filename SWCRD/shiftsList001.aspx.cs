...
public partial class SWCRD_shiftsList001 : System.Web.UI.Page
{
    ...
    protected void SET()
    {
        ...
        string strSQLRV = "SELECT          TOP (10) S.SWC02, S.SWC05, G.GSLType,S.SWC22, G.GSL002, convert(varchar, G.GSL003, 111)  as GSL003, G.Savedate, G.saveuser ";
        strSQLRV += "  FROM              GuildShiftsList AS G INNER JOIN  SWCSWC AS S ON G.SWC000 = S.SWC00  ";
        strSQLRV += " WHERE S.SWC04<>'不予受理' AND          (G.GSLType LIKE '%審查%') order by G.id desc ";
    ...
    private void setGridViewData()
    {
        ...
        string gvData02 = " select * from GuildShifts where GS001='1' and GS002<>'ge-50702' and isnull(GS009,'1')='1' order by isnull(GS004, 0);";
