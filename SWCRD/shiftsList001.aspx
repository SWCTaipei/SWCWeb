<%@ Page Title="委託歷程一覽表" Language="C#" MasterPageFile="~/PriPage/MasterPageA.master" AutoEventWireup="true" CodeFile="shiftsList001.aspx.cs" Inherits="SWCRD_shiftsList001" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="content-s">
        <div><img src="../images/btn/btn-12.jpg" /></div><br />
            ...
            <div class="linkwrap">
                <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="~/SWCRD/shiftsList001.aspx" CssClass="linkstyle1">&nbsp;&nbsp;&nbsp;審&nbsp;&nbsp;&nbsp;查&nbsp;&nbsp;&nbsp;</asp:HyperLink>
                <asp:HyperLink ID="HyperLink4" runat="server" NavigateUrl="~/SWCRD/shiftsList002.aspx" CssClass="linkstyle2">&nbsp;&nbsp;&nbsp;檢&nbsp;&nbsp;&nbsp;查&nbsp;&nbsp;&nbsp;</asp:HyperLink>
        <div>
                <span class="intitle">目前待派審查單位順序</span>
                    ...
                    <asp:GridView ID="GridView1" runat="server" Cellspacing="0" CellPadding="4" CssClass="ADDGridView AutoNewLine" GridLines="None" style="width:100%;border-collapse:collapse;border-collapse:collapse;"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="GS003" HeaderText="審查單位" SortExpression="GS003" />
                        </Columns>
                    </asp:GridView>
                    <asp:SqlDataSource ID="SqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:TSLMSWCCONN %>"
                        SelectCommand=" select top 6 RANK() OVER(ORDER BY isnull(GS005, 0) + isnull(GS006, 0)+isnull(GS007, 0),isnull(GS004, 0)) AS ROWID,* from GuildShifts where GS001='1' and GS002<>'ge-50702' and isnull(GS009,'1')='1' order by isnull(GS005, 0) + isnull(GS006, 0)+isnull(GS007, 0),isnull(GS004, 0); " >
                    </asp:SqlDataSource> </div>
                
        <br />
        <div><!--以下綠色表格條件為:施工中且檢查公會為該帳+完工申報書決行且核准的-->
          <span class="intitle">已委派案件之審查單位（顯示近10筆）</span>
              ...
              <asp:GridView ID="GridView2" runat="server" CssClass="ADDGridView AutoNewLine ADDother" style="width:100%;border-collapse:collapse;border-collapse:collapse;"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="SWC02" HeaderText="行政審查案件編號" SortExpression="SWC02"  >
                             ...
                             <asp:BoundField DataField="SWC22" HeaderText="審查單位" SortExpression="SWC22" >
