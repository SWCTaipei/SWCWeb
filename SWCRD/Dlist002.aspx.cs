...
public partial class SWCRD_Dlist002 : System.Web.UI.Page
{
    int ChkOverDay = 6;
    ...
    private void setGVDate()
    {
        ...
        string tmpSWC000Str = "";
        string tmpONA02 = " select DISTINCT SWC000 from OnlineApply02 where ISNULL(DATALOCK2,'')='Y' and DATEADD(day,8, savedate) > getdate(); ";
        string tmpONA03 = " select DISTINCT SWC000 from OnlineApply03 where ISNULL(DATALOCK2,'')='Y' and DATEADD(day,8, savedate) > getdate(); ";
        string tmpONA04 = " select DISTINCT SWC000 from OnlineApply04 where ISNULL(DATALOCK2,'')='Y' and DATEADD(day,8, savedate) > getdate(); ";
        string tmpONA05 = " select DISTINCT SWC000 from OnlineApply05 where ISNULL(DATALOCK2,'')='Y' and DATEADD(day,8, savedate) > getdate(); ";
        string tmpONA06 = " select DISTINCT SWC000 from OnlineApply06 where ISNULL(DATALOCK2,'')='Y' and DATEADD(day,8, savedate) > getdate(); ";
        string tmpONA07 = " select DISTINCT SWC000 from OnlineApply07 where ISNULL(DATALOCK2,'')='Y' and DATEADD(day,8, savedate) > getdate(); ";
        string tmpONA08 = " select DISTINCT SWC000 from OnlineApply08 where ISNULL(DATALOCK2,'')='Y' and DATEADD(day,8, savedate) > getdate(); ";
        string tmpONA09 = " select DISTINCT SWC000 from OnlineApply09 where ISNULL(DATALOCK2,'')='Y' and DATEADD(day,8, savedate) > getdate(); ";
        ...
        string tmpSwcswc = " select * from SWCCASE where swc000 in (" + swcRange + ") and (SWC021ID=N'"+ ssUserID + "' OR SWC045ID=N'"+ ssUserID + "') order by swc000 desc";
