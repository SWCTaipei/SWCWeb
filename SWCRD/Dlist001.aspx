<%@ Page Title="待辦報表" Language="C#" MasterPageFile="~/PriPage/MasterPageA.master" AutoEventWireup="true" CodeFile="Dlist001.aspx.cs" Inherits="SWCRD_Dlist001" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="content-s">
        ...
        <div class="linkwrap">
            <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="~/SWCRD/Dlist001.aspx" CssClass="linkstyle1">暫&nbsp;&nbsp;存&nbsp;&nbsp;中</asp:HyperLink>
            <asp:HyperLink ID="HyperLink4" runat="server" NavigateUrl="~/SWCRD/Dlist002.aspx" CssClass="linkstyle2">近期報表</asp:HyperLink>

       
    <div class="tab">
    <div class="intitle">暫存中</div>
