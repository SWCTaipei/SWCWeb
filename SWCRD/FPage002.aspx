<%@ Page Title="設定檢查技師" Language="C#" MasterPageFile="~/PriPage/MasterPageA.master" AutoEventWireup="true" CodeFile="FPage002.aspx.cs" Inherits="SWCRD_FPage001" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="content-s">
        <div class="content-s">
            ...
            <div class="linkwrap">
                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/SWCRD/FPage001.aspx" CssClass="linkstyle2">審查案件列表</asp:HyperLink>
                <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/SWCRD/FPage002.aspx" CssClass="linkstyle1">檢查案件列表</asp:HyperLink>
                ...
                <div class="tabssss">
                  ...
                  <asp:GridView ID="GridView2" runat="server" CellSpacing="0" CellPadding="4" CssClass="ADDGridView AutoNewLine FP02" GridLines="None" Style="width: 100%; border-collapse: collapse; border-collapse: collapse;"
                ...
                <div class="intitle">完工檢查列表</div>

               
                    
                  <asp:GridView ID="GridView3" runat="server" CellSpacing="0" CellPadding="4" CssClass="ADDGridView FP02 ADDother AutoNewLine" GridLines="None" Style="width: 100%; border-collapse: collapse; border-collapse: collapse;"
