...
public partial class SwcReport_PdfSwcDtl06 : System.Web.UI.Page
{
    ...
    private void GenPdf()
    {
        ...
        //PDF套表開始
        PdfReader Pdfreader = new PdfReader(Server.MapPath("../OutputFile/Sample/OLA003.pdf"));
        ...
        string ExeSqlStr = " select SWC.SWC005,OA3.*,EU.ETName from OnlineApply03 OA3 ";
        ExeSqlStr = ExeSqlStr + " left JOIN SWCCASE SWC ON OA3.SWC000=SWC.SWC000 ";
        ExeSqlStr += " left JOIN ETUsers EU on OA3.LOCKUSER=EU.ETID ";
        ExeSqlStr = ExeSqlStr + " where OA3.SWC000 = '" + rSWCNO + "' ";
        ExeSqlStr = ExeSqlStr + "   and OA3.ONA03001 = '" + rOLANO + "' ";
        ...
        using (SqlConnection SwcConn = new SqlConnection(connectionString.ConnectionString))
        {
            ...
            while (readeSwc.Read())
            {
                ...
                string tONA03003 = readeSwc["ONA03003"] + "";
                ...
                //2.暫停期限(迄)
                string Year003 = " " + Convert.ToString(Convert.ToDateTime(tONA03003).Year - 1911);
                string Month003 = " " + Convert.ToString(Convert.ToDateTime(tONA03003).Month);
                string Day003 = " " + Convert.ToString(Convert.ToDateTime(tONA03003).Day);
                //判斷日期1900-01-01
                if (Convert.ToString(Convert.ToDateTime(tONA03003).Year) == "1900" && Convert.ToString(Convert.ToDateTime(tONA03003).Month) == "1" && Convert.ToString(Convert.ToDateTime(tONA03003).Day) == "1")
                {
                    Year003 = " ";
                    Month003 = " ";
                    Day003 = " ";
                ...
                ps = Pdfstamper.AcroFields.GetFieldPositions("ONA03003a");
                p = ps[0];
                ct = new ColumnText(Pdfstamper.GetOverContent(p.page));
                ...
                ct.Go();
                Pdfstamper.AcroFields.RemoveField("ONA03003a");

                ps = Pdfstamper.AcroFields.GetFieldPositions("ONA03003b");
                p = ps[0];
                ct = new ColumnText(Pdfstamper.GetOverContent(p.page));
                ...
                ct.Go();
                Pdfstamper.AcroFields.RemoveField("ONA03003b");

                ps = Pdfstamper.AcroFields.GetFieldPositions("ONA03003c");
                p = ps[0];
                ct = new ColumnText(Pdfstamper.GetOverContent(p.page));
                ...
                ct.Go();
                Pdfstamper.AcroFields.RemoveField("ONA03003c");
