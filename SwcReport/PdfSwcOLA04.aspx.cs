...
public partial class SwcReport_PdfSwcDtl06 : System.Web.UI.Page
{
    ...
    private void GenPdf()
    {
        ...
        //PDF套表開始
        PdfReader Pdfreader = new PdfReader(Server.MapPath("../OutputFile/Sample/OLA004.pdf"));
        ...
        string ExeSqlStr = " select SWC.SWC005,OA4.*,EU.ETName from OnlineApply04 OA4 ";
        ExeSqlStr = ExeSqlStr + " left JOIN SWCCASE SWC ON OA4.SWC000=SWC.SWC000 ";
        ExeSqlStr += " left JOIN ETUsers EU on OA4.LOCKUSER=EU.ETID ";
        ExeSqlStr = ExeSqlStr + " where OA4.SWC000 = '" + rSWCNO + "' ";
        ExeSqlStr = ExeSqlStr + "   and OA4.ONA04001 = '" + rOLANO + "' ";
        ...
        using (SqlConnection SwcConn = new SqlConnection(connectionString.ConnectionString))
        {
            ...
            while (readeSwc.Read())
            {
                ...
                string tONA04004 = readeSwc["ONA04004"] + "";
                ...
                //2.暫停期限(迄)
                string Year003 = " " + Convert.ToString(Convert.ToDateTime(tONA04004).Year - 1911);
                string Month003 = " " + Convert.ToString(Convert.ToDateTime(tONA04004).Month);
                string Day003 = " " + Convert.ToString(Convert.ToDateTime(tONA04004).Day);
                //判斷日期1900-01-01
                if (Convert.ToString(Convert.ToDateTime(tONA04004).Year) == "1900" && Convert.ToString(Convert.ToDateTime(tONA04004).Month) == "1" && Convert.ToString(Convert.ToDateTime(tONA04004).Day) == "1")
                {
                    Year003 = " ";
                    Month003 = " ";
                    Day003 = " ";
                ...
                ps = Pdfstamper.AcroFields.GetFieldPositions("ONA04004a");
                p = ps[0];
                ct = new ColumnText(Pdfstamper.GetOverContent(p.page));
                ...
                ct.Go();
                Pdfstamper.AcroFields.RemoveField("ONA04004a");

                ps = Pdfstamper.AcroFields.GetFieldPositions("ONA04004b");
                p = ps[0];
                ct = new ColumnText(Pdfstamper.GetOverContent(p.page));
                ...
                ct.Go();
                Pdfstamper.AcroFields.RemoveField("ONA04004b");

                ps = Pdfstamper.AcroFields.GetFieldPositions("ONA04004c");
                p = ps[0];
                ct = new ColumnText(Pdfstamper.GetOverContent(p.page));
                ...
                ct.Go();
                Pdfstamper.AcroFields.RemoveField("ONA04004c");
