...
public partial class SwcReport_PdfSwcDtl06 : System.Web.UI.Page
{
    ...
    private void GenPdf()
    {
        ...
        //PDF套表開始
        PdfReader Pdfreader = new PdfReader(Server.MapPath("../OutputFile/Sample/OLA002.pdf"));
        ...
        string ExeSqlStr = " select SWC.SWC005,OA2.*,EU.ETName from OnlineApply02 OA2 ";
        ExeSqlStr = ExeSqlStr + " left JOIN SWCCASE SWC ON OA2.SWC000=SWC.SWC000 ";
        ExeSqlStr += " left JOIN ETUsers EU on OA2.LOCKUSER=EU.ETID ";
        ExeSqlStr = ExeSqlStr + " where OA2.SWC000 = '" + rSWCNO + "' ";
        ExeSqlStr = ExeSqlStr + "   and OA2.ONA02001 = '" + rOLANO + "' ";
        ...
        using (SqlConnection SwcConn = new SqlConnection(connectionString.ConnectionString))
        {
            ...
            while (readeSwc.Read())
            {
                ...
                string tONA02003 = readeSwc["ONA02003"] + "";
                ...
                //2.暫停期限(迄)
                string Year003 = " " + Convert.ToString(Convert.ToDateTime(tONA02003).Year - 1911);
                string Month003 = " " + Convert.ToString(Convert.ToDateTime(tONA02003).Month);
                string Day003 = " " + Convert.ToString(Convert.ToDateTime(tONA02003).Day);
                //判斷日期1900-01-01
                if (Convert.ToString(Convert.ToDateTime(tONA02003).Year) == "1900" && Convert.ToString(Convert.ToDateTime(tONA02003).Month) == "1" && Convert.ToString(Convert.ToDateTime(tONA02003).Day) == "1")
                {
                    Year003 = " ";
                    Month003 = " ";
                    Day003 = " ";
                ...
                ps = Pdfstamper.AcroFields.GetFieldPositions("ONA02003a");
                p = ps[0];
                ct = new ColumnText(Pdfstamper.GetOverContent(p.page));
                ...
                ct.Go();
                Pdfstamper.AcroFields.RemoveField("ONA02003a");

                ps = Pdfstamper.AcroFields.GetFieldPositions("ONA02003b");
                p = ps[0];
                ct = new ColumnText(Pdfstamper.GetOverContent(p.page));
                ...
                ct.Go();
                Pdfstamper.AcroFields.RemoveField("ONA02003b");

                ps = Pdfstamper.AcroFields.GetFieldPositions("ONA02003c");
                p = ps[0];
                ct = new ColumnText(Pdfstamper.GetOverContent(p.page));
                ...
                ct.Go();
                Pdfstamper.AcroFields.RemoveField("ONA02003c");
