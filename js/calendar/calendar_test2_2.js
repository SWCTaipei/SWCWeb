function c(QQ){
	...
	for (var x = 0; x < obj.length; x++) {
		...
		var Q = '{ "case": "' + objj[0] + '", "title": "' + objj[3] + ',' + objj[6] + '" , "start": "' + objj[1] + '",  "end": "' + objj[2] + '" , "obligor": "' + objj[3] + '", "caseno": "' + objj[4] + '", "place": "' + objj[5] + '", "area": "' + objj[6] + '", "backgroundColor": "' + objj[7] + '", "people": "' + objj[8] + '", "guild": "' + objj[9] + '"}';
