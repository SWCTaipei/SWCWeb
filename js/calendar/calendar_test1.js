function c(QQ){
	...
	for (var x = 0; x < obj.length; x++) {
		...
		//書件;起;迄;義務人;案件編號;地點;地區;承辦技師;審查公會;顏色
		var Q = '{ "case": "' + objj[0] + '", "title": "' + objj[3] + ',' + objj[6] + '" , "start": "' + objj[1] + '",  "end": "' + objj[2] + '" , "obligor": "' + objj[3] + '", "caseno": "' + objj[4] + '", "place": "' + objj[5] + '", "area": "' + objj[6] + '", "people": "' + objj[7] + '", "guild": "' + objj[8] + '", "backgroundColor": "#ba9880"}';
