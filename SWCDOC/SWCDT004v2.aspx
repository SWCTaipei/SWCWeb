...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SWCDT004v2.aspx.cs" Inherits="SWCDOC_SWCDT004" %>
        ...
        <div class="content-s">
            ...
            <table class="checklist-out">
                ...
                <tr><td>自主檢查結果<span style="color: red;font-family:cursive;">＊</span></td>
                    <td><asp:Label ID="TXTDTL004" runat="server" /><br/></td></tr>
            </table>
            ...
            <tr><td class="td-padding">
                ...
                <td><asp:TextBox ID="TXTDTL007" runat="server" onkeyup="textcount(this,'TXTDTL007_count','50');" />
                    <asp:Label ID="TXTDTL007_count" runat="server" Text="(0/50)" ForeColor="Red" /></td>
                <td><asp:TextBox ID="TXTDTL008" runat="server" onkeyup="textcount(this,'TXTDTL008_count','50');" />
            ...
            <tr><td class="td-padding">
                ...
                <td><asp:TextBox ID="TXTDTL011" runat="server" onkeyup="textcount(this,'TXTDTL011_count','50');" />
                    <asp:Label ID="TXTDTL011_count" runat="server" Text="(0/50)" ForeColor="Red" /></td>
                <td><asp:TextBox ID="TXTDTL012" runat="server" onkeyup="textcount(this,'TXTDTL012_count','50');" />
            ...
            <tr><td class="td-padding">
                ...
                <td><asp:TextBox ID="TXTDTL015" runat="server" onkeyup="textcount(this,'TXTDTL015_count','50');" />
                    <asp:Label ID="TXTDTL015_count" runat="server" Text="(0/50)" ForeColor="Red" /></td>
                <td><asp:TextBox ID="TXTDTL016" runat="server" onkeyup="textcount(this,'TXTDTL016_count','50');" />
            ...
            <tr><td class="td-padding">
                ...
                <td><asp:TextBox ID="TXTDTL019" runat="server" onkeyup="textcount(this,'TXTDTL019_count','50');" />
                    <asp:Label ID="TXTDTL019_count" runat="server" Text="(0/50)" ForeColor="Red" /></td>
                <td><asp:TextBox ID="TXTDTL020" runat="server" onkeyup="textcount(this,'TXTDTL020_count','50');" />
            ...
            <tr><td class="td-padding">
                ...
                <td><asp:TextBox ID="TXTDTL023" runat="server" onkeyup="textcount(this,'TXTDTL023_count','50');" />
                    <asp:Label ID="TXTDTL023_count" runat="server" Text="(0/50)" ForeColor="Red" /></td>
                <td><asp:TextBox ID="TXTDTL024" runat="server" onkeyup="textcount(this,'TXTDTL024_count','50');" />
            ...
            <tr><td class="td-padding">
                ...
                <td><asp:TextBox ID="TXTDTL027" runat="server" onkeyup="textcount(this,'TXTDTL027_count','50');" />
                    <asp:Label ID="TXTDTL027_count" runat="server" Text="(0/50)" ForeColor="Red" /></td>
                <td><asp:TextBox ID="TXTDTL028" runat="server" onkeyup="textcount(this,'TXTDTL028_count','50');" />
            ...
            <tr><td class="td-padding">
                ...
                <td><asp:TextBox ID="TXTDTL031" runat="server" onkeyup="textcount(this,'TXTDTL031_count','50');" />
                    <asp:Label ID="TXTDTL031_count" runat="server" Text="(0/50)" ForeColor="Red" /></td>
                <td><asp:TextBox ID="TXTDTL032" runat="server" onkeyup="textcount(this,'TXTDTL032_count','50');" />
            ...
            <tr><td class="td-padding">
                ...
                <td><asp:TextBox ID="TXTDTL035" runat="server" onkeyup="textcount(this,'TXTDTL035_count','50');" />
                    <asp:Label ID="TXTDTL035_count" runat="server" Text="(0/50)" ForeColor="Red" /></td>
                <td><asp:TextBox ID="TXTDTL036" runat="server" onkeyup="textcount(this,'TXTDTL036_count','50');" />
            ...
            <tr><td class="td-padding">
                ...
                <td><asp:TextBox ID="TXTDTL039" runat="server" onkeyup="textcount(this,'TXTDTL039_count','50');" />
                    <asp:Label ID="TXTDTL039_count" runat="server" Text="(0/50)" ForeColor="Red" /></td>
                <td><asp:TextBox ID="TXTDTL040" runat="server" onkeyup="textcount(this,'TXTDTL040_count','50');" />
            ...
            <tr><td class="td-padding">
                ...
                <td><asp:TextBox ID="TXTDTL043" runat="server" onkeyup="textcount(this,'TXTDTL043_count','50');" />
                    <asp:Label ID="TXTDTL043_count" runat="server" Text="(0/50)" ForeColor="Red" /></td>
                <td><asp:TextBox ID="TXTDTL044" runat="server" onkeyup="textcount(this,'TXTDTL044_count','50');" />
            ...
            <tr><td class="td-padding">
                ...
                <td><asp:TextBox ID="TXTDTL047" runat="server" onkeyup="textcount(this,'TXTDTL047_count','50');" />
                    <asp:Label ID="TXTDTL047_count" runat="server" Text="(0/50)" ForeColor="Red" /></td>
                <td><asp:TextBox ID="TXTDTL048" runat="server" onkeyup="textcount(this,'TXTDTL048_count','50');" />
            ...
            <tr><td class="td-padding">
                ...
                <td><asp:TextBox ID="TXTDTL051" runat="server" onkeyup="textcount(this,'TXTDTL051_count','50');" />
                    <asp:Label ID="TXTDTL051_count" runat="server" Text="(0/50)" ForeColor="Red" /></td>
                <td><asp:TextBox ID="TXTDTL052" runat="server" onkeyup="textcount(this,'TXTDTL052_count','50');" />
            ...
            <tr><td class="td-padding">
                ...
                <td><asp:TextBox ID="TXTDTL055" runat="server" onkeyup="textcount(this,'TXTDTL055_count','50');" />
                    <asp:Label ID="TXTDTL055_count" runat="server" Text="(0/50)" ForeColor="Red" /></td>
                <td><asp:TextBox ID="TXTDTL056" runat="server" onkeyup="textcount(this,'TXTDTL056_count','50');" />
            ...
            <tr><td class="td-padding">
                ...
                <td><asp:TextBox ID="TXTDTL059" runat="server" onkeyup="textcount(this,'TXTDTL059_count','50');" />
                    <asp:Label ID="TXTDTL059_count" runat="server" Text="(0/50)" ForeColor="Red" /></td>
                <td><asp:TextBox ID="TXTDTL060" runat="server" onkeyup="textcount(this,'TXTDTL060_count','50');" />
            ...
            <tr><td class="td-padding">
                ...
                <td><asp:TextBox ID="TXTDTL063" runat="server" onkeyup="textcount(this,'TXTDTL063_count','50');" />
                    <asp:Label ID="TXTDTL063_count" runat="server" Text="(0/50)" ForeColor="Red" /></td>
                <td><asp:TextBox ID="TXTDTL064" runat="server" onkeyup="textcount(this,'TXTDTL064_count','50');" />
            ...
            <tr><td class="td-padding">
                ...
                <td><asp:TextBox ID="TXTDTL067" runat="server" onkeyup="textcount(this,'TXTDTL067_count','50');" />
                    <asp:Label ID="TXTDTL067_count" runat="server" Text="(0/50)" ForeColor="Red" /></td>
                <td><asp:TextBox ID="TXTDTL068" runat="server" onkeyup="textcount(this,'TXTDTL068_count','50');" />
            ...
            <tr><td class="td-padding">
                ...
                <td><asp:TextBox ID="TXTDTL071" runat="server" onkeyup="textcount(this,'TXTDTL071_count','50');" />
                    <asp:Label ID="TXTDTL071_count" runat="server" Text="(0/50)" ForeColor="Red" /></td>
                <td><asp:TextBox ID="TXTDTL072" runat="server" onkeyup="textcount(this,'TXTDTL072_count','50');" />
            ...
            <tr><td class="td-padding">
                ...
                <td><asp:TextBox ID="TXTDTL075" runat="server" onkeyup="textcount(this,'TXTDTL075_count','50');" />
                    <asp:Label ID="TXTDTL075_count" runat="server" Text="(0/50)" ForeColor="Red" /></td>
                <td><asp:TextBox ID="TXTDTL076" runat="server" onkeyup="textcount(this,'TXTDTL076_count','50');" />
            ...
            <tr><td colspan="7" style="border-bottom:none;">其他事項：<br/><br/>
                    <asp:Label ID="TXTDTL077" runat="server"  /></td></tr>
                <tr><td colspan="7" style="text-align:right;border-top:none;">檢查日期：
                        <asp:Label ID="TXTDTL078" runat="server" width="120px"></asp:Label></td></tr>
                <tr><td colspan="7">二、相關單位及人員簽名<br/><br/>
                        <asp:Label ID="TXTDTL079" runat="server" /><br/>
                        <p style="line-height:2.5;">註:1.本表格請依所核水土保持設施項目填報，無此項或尚未施作項目請於備註欄說明。並視所需自行增減欄位。<br/></p>
                        <p style="padding-left:20px;margin-top:10px;">2.請水土保持義務人會同承辦監造技師及施工廠商，於中央氣象局發布海上颱風警報或豪雨特報後填列本表,並以傳真或電子郵件傳送至監督管理機關。</p>
                            </td></tr>
                </table>
                ...
                <tr><td style="border-top:none;text-align:center;">
                    <div class="imgUpload-btn">
                        ...
                        <asp:Image ID="TXTDTL080_img" runat="server" CssClass="imgUpload" />
                    </div><br/>
                        <asp:Label ID="TXTDTL081" runat="server" />
                    ...
                    <div class="imgUpload-btn">
                        ...
                        <asp:Image ID="TXTDTL082_img" runat="server" CssClass="imgUpload" />
                    </div><br/>
                        <asp:Label ID="TXTDTL083" runat="server" />
...
<%--        <div class="footer-s">
            ...
            <div class="footer">
                <p> <span class="span1">臺北市政府工務局大地工程處</span>
                    <br><span class="span2">110臺北市信義區松德路300號3樓 　(02)27591109   臺北市民當家熱線1999</span>
                    <br><span class="span2">資料更新：<asp:Label ID="ToDay" runat="server" Text=""/>　來訪人數：<asp:Label ID="Visitor" runat="server" Text=""/> </span></p>
            </div>
        </div>
