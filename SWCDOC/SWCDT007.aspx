...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        function chkInput(jChkType) {
            ...
            jCHKValue54 = document.getElementById("TXTDTL054").value;
            ...
            if (jCHKValue54.trim() == '') {
                ...
                if (!dateValidationCheck(jCHKValue54)) {
                    document.getElementById("TXTDTL054").focus();
                    return false;
                }
            }
        ...
        <div class="header-wrap-s">
            ...
            <div class="header-s-green">
                <div class="header-s-green-nameWrap">
                    <span><asp:Literal ID="TextUserName" runat="server"></asp:Literal></span>
                </div>
            </div>
        </div>
        ...
        <div class="content-s">
            <div class="facilityMaintain form">
                ...
                <tr><td>四、相關單位人員簽名<br/>
                        ...
                        相關人員：<asp:TextBox ID="TextBox_01" runat="server" width="200px"/>
                    ...
                    <td><asp:Image ID="TXTDTL060_img" runat="server" CssClass="imgUpload-l90" Visible="false" /><br/>
                        ...
                        <asp:Button ID="TXTDTL060_fileuploaddel" runat="server" Text="x" ToolTip="刪除上傳照片" OnClientClick="return confirm('照片刪除後無法復原，請確是否要刪除照片!!!')" OnClick="TXTDTL060_fileuploaddel_Click" /></td></tr>
                </table>
                ...
                <tr><td colspan="2">
                        ...
                        <asp:HyperLink ID="HyperLink062" runat="server" CssClass="imgUpload" Target="_blank" ></asp:HyperLink>
                    </td>
                    <td colspan="2">
                        <div class="imgUpload-btn">
                ...
                <tr><td colspan="4">其他附件檔案上傳：
                        ...
                        <br/><br/>
                        <span style="color:red;">檔案大小請小於 10 Mb，請上傳 jpg, png, doc, pdf, dwg, dxf 格式</span>
                        <br/><br/>
