<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PWA_list.aspx.cs" Inherits="SWCDOC_PWA_list" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
	...
	<script type="text/javascript">
		...
		req.onsuccess = function (e) {
			db = e.target.result;
			var txn = db.transaction("SWCDT003", "readonly");
			...
			//沒有資料文字顯示
			var panel = document.getElementById("PanelTable_Temp1");
		...
		function tempdata1_1(a){
			...
			td = document.createElement('td');
			text = document.createTextNode("施工監督檢查");
			td.appendChild(text);
			...
			a.setAttribute('href', '../PWA_SWCDT003/SWCDT003PWA.aspx?SWCNO=' + data[1] + '&DTLNO=AddNew');
		...
		function tempdata2(){
			...
			req.onsuccess = function (e) {
				db = e.target.result;
				var txn = db.transaction("SWCDT004", "readonly");
				...
				//沒有資料文字顯示
				var panel = document.getElementById("PanelTable_Temp2");
				var div = document.createElement("div");
				var text = document.createTextNode("目前沒有暫存資料");
				div.appendChild(text);
				panel.appendChild(div);
		...
		function tempdata2_1(a){
			...
			td = document.createElement('td');
			text = document.createTextNode("颱風及豪雨設施自主檢查	");
			td.appendChild(text);
			...
			var a = document.createElement('a');
			a.setAttribute('target', '_blank');
			a.setAttribute('href', '../PWA_SWCDT004/SWCDT004PWA.aspx?SWCNO=' + data[1] + '&DTLNO=AddNew');
			text = document.createTextNode("詳情");
			a.appendChild(text);
			td.appendChild(a);
		...
		function tempdata3(){
			...
			req.onsuccess = function (e) {
				db = e.target.result;
				var txn = db.transaction("SWCDT006", "readonly");
				...
				//沒有資料文字顯示
				var panel = document.getElementById("PanelTable_Temp3");
				var div = document.createElement("div");
				var text = document.createTextNode("目前沒有暫存資料");
				div.appendChild(text);
				panel.appendChild(div);
		...
		function tempdata3_1(a){
			...
			td = document.createElement('td');
			text = document.createTextNode("完工檢查");
			td.appendChild(text);
			...
			var a = document.createElement('a');
			a.setAttribute('target', '_blank');
			a.setAttribute('href', '../PWA_SWCDT006/SWCDT006PWA.aspx?SWCNO=' + data[1] + '&DTLNO=AddNew');
			text = document.createTextNode("詳情");
			a.appendChild(text);
			td.appendChild(a);
                ...
                <div class="tab_content">
                  <div class="PWA_noup">
                   <div class="noup_title">已暫存未送出</div>
					<div class="PWA_tempTT">施工監督檢查</div>
			   	    <asp:Panel ID="PanelTable_Temp1" runat="server">
			   	    </asp:Panel><br/><br/>
					<div class="PWA_tempTT">颱風及豪雨設施自主檢查</div>
					<asp:Panel ID="PanelTable_Temp2" runat="server">
			   	    </asp:Panel><br/><br/>
					<div class="PWA_tempTT">完工檢查</div>
					<asp:Panel ID="PanelTable_Temp3" runat="server">
			   	    </asp:Panel>
                  </div>
               </div>
               <!-- TAB2 打包區塊 end -->
