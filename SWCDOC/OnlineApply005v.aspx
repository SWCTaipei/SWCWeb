      ...
      <h1>水土保持計畫設施調整報備<br>
        <br>
                ...
                <tr><td>調整報備項目是否屬永久設施</td>
                    <td><asp:Label ID="DDLONA002" runat="server"/></td></tr>
                <tr><td>申請調整項目</td>
                    <td style="line-height:40px;">
                        ...
                        <asp:CheckBox ID="CHKBOXONA005" runat="server" Enabled="false" Text=" 三、各單項水保設施，其計量單位之數量增減不超過20%者" /><br/>
                        ...
                        <asp:CheckBox ID="CHKBOXONA008" runat="server" Enabled="false" Text=" 六、變更水保設施之構造物斷面及通水斷面，面積增加不超過20%或減少不超過10%，且不影響原構造物正常功能" /><br/>
                        <asp:CheckBox ID="CHKBOXONA009" runat="server" Enabled="false" Text=" 七、因應實際需要，依水土保持技術規範增設必要臨時防災措施" /><br/>
                        <asp:CheckBox ID="CHKBOXONA010" runat="server" Enabled="false" Text=" 八、其它未涉及變更水保開挖整地位置及水保設施之調整報備事項，如純屬建築配置變更、二樓板勘驗前完工限制解列等" /><br/>
                    </td></tr>
                <tr><td style="line-height:1.5"> 承辦監造技師確認安全無虞之簽證說明書 </td>
                    <td><asp:TextBox ID="TXTONA011" runat="server" Width="70px" Visible="False" />
                        <asp:HyperLink ID="Link011" runat="server" Target="_blank" /></td></tr>
                <tr><td colspan="2">
                        <asp:CheckBox ID="CHKBOXONA012" runat="server" Enabled="false" Text="經確認符合水土保持計畫審核監督辦法第19條變更設計且安全無虞。" /></td>
                </tr>
