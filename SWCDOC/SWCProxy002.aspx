<%@ Page Title="臺北市水土保持申請書件管理平台" Language="C#" MasterPageFile="~/PriPage/MasterPageA.master" AutoEventWireup="true" CodeFile="SWCProxy002.aspx.cs" Inherits="SWCDOC_SWCProxy002" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="content-s">
		<div id="ToCalendar" class="lookCD"><a href="#">台北通基本資料</a></div><br><br><br>
         <div class="applyGrid">
          <h2 class="detailsBar_title_basic">基本資料</h2>
        <table class="ph-table">
            <tr><th style="width:200px; text-align: center;">姓名</th>
                <td><asp:TextBox ID="TXTProxyName" runat="server"/></td></tr>
            <tr><th style="width:200px; text-align: center;">身分證字號</th>
                <td><asp:TextBox ID="TXTProxyID" runat="server"/></td></tr>
            <tr><th style="width:200px; text-align: center;">手機</th>
                <td><asp:TextBox ID="TXTProxyPhoneNo" runat="server"/></td></tr>
        </table>
	   <br><br>
		<div class="center">
		...
		<asp:GridView ID="ProxyList" runat="server" AutoGenerateColumns="False" CssClass="ADDGridView AutoNewLine" Height="50" EmptyDataText="查無資料" OnRowCommand="ProxyList_RowCommand">
            <Columns>
