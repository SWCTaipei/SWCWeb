...
public partial class SWCDOC_OnlineApply008 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            SBApp.ViewRecord("水土保持計畫停工申請", "view", "");
            if (rRRPG == "55")
            {
        ...
        using (SqlConnection SwcConn = new SqlConnection(connectionString.ConnectionString))
        {
            ...
            else
            {
                ...
                while (readeONA.Read())
                {
                    ...
                    if (tONA009 != "") { TXTONA009.Visible = true; }
                    ...
                    ReviewID.Text = "存檔人：" + SBApp.GetGeoUser(tLOCKUSER2, "Name");
    ...
    private void DeleteUpLoadFile(string DelType, TextBox ImgText, System.Web.UI.WebControls.Image ImgView, HyperLink FileLink, string DelFieldValue, string AspxFeildId, int NoneWidth, int NoneHeight)
    {
        ...
        strSQLClearFieldValue = " update OnlineApply08 set ";
        ...
        strSQLClearFieldValue = strSQLClearFieldValue + "   and ONA08001 = '" + csCaseID2 + "' ";
    ...
    {
        ConvertClass CVT = new ConvertClass();
        ...
        using (SqlConnection SwcConn = new SqlConnection(connectionString.ConnectionString))
        {
            ...
            GBC.RecordTrunHistory(sSWC000, sSWC002, sONA08001, sReviewResults, ssUserID, sReviewDirections, sReSendDeadline);
            switch (sReviewResults)
            {
                case "核准":
                    //2019-03-28 核准後，直接將【預計停工期限】代入 水保申請案的【停工日期 SWC53、停工期限 SWC84】
                    string sONA003 = TXTONA003.Text + "";
                    string sONA004 = TXTONA004.Text + "";

                    sONA003 = CVT.ADDate(sONA003);
                    sONA004 = CVT.ADDate(sONA004);

                    string exeSQL = " Update SWCCASE Set SWC053=N'" + sONA003 + "',SWC084=N'"+ sONA004 + "' Where SWC000 = '" + sSWC000 + "' ";
                    string exeSQL55 = " Update SWCSWC Set SWC53=N'" + sONA003 + "',SWC84=N'" + sONA004 + "' Where SWC00 = '" + sSWC000 + "' ";
    ...
    protected void TXTReviewDoc_fileuploadok_Click(object sender, EventArgs e)
    {
        ...
        error_msg.Text = "";
        FileUpLoadApp("DOC", TXTReviewDoc_fileupload, TXTReviewDoc, "TXTReviewDoc", "_" + rONANO + "_08_ReviewDoc", null, LinkReviewDoc, 60);
    }
    ...
    protected void OutPdf_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Response.Redirect("../SwcReport/PdfSwcOLA08.aspx?SWCNO=" + rSWCNO + "&OLANO=" + rOLANO);
    }
}