...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LIST024.aspx.cs" Inherits="SWCDOC_LIST024" %>
...
<body>
    ...
    <div class="wrap-s">
         ...
         <div class="header header-s clearfix"><a href="HaloPage001.aspx" class="logo-s"></a>
             ...
             <div>
                ...
                <ul>
                    ...
                    <asp:Panel ID="TitleLink01" runat="server" Visible="false"><li>|&nbsp&nbsp&nbsp&nbsp<a href="BasicInfo/BasPg001.aspx" title="權限管理">權限管理</a></li></asp:Panel>
                    <asp:Panel ID="UserBoard00" runat="server" Visible="false"><li>|&nbsp&nbsp&nbsp&nbsp<a href="UserBoard.aspx" title="留言板">留言板</a></li></asp:Panel>
                    <asp:Panel ID="GOVMG" runat="server" Visible="false"><li class="system">|&nbsp&nbsp&nbsp&nbsp<a href="../SWCTCGOV/SWCGOV001.aspx" title="系統管理">系統管理</a><ul><li><a href="../SWCTCGOV/SWCGOV001.aspx">防災事件通知</a></li><li><a href="../SWCTCGOV/SWCGOV011.aspx">公佈欄</a></li><li><a href="../SWCDOC/UserBoard.aspx">留言版</a></li></ul></li></asp:Panel>
                    <li>|</li>
            ...
            <div class="contentFooter">
                <div class="content-s content-s-inquire">
                    <div class="inquireForm date">
                        ...
                        <asp:CheckBox ID="CHKSHTYPE" runat="server"  Text="案件變更申請" onclick="SearchChg(this);" Visible="false" Style="margin-left:26%; font-weight:bolder;color:#0000ff; display:none"/>
                        <br/>
                        <span>書件名稱：</span>
                        ...
                        <br/>
                    <!--  <asp:Panel ID="SwcArea02" runat="server" style="display:none">
                        <span>水保義務人：</span>
            ...
            <asp:Panel ID="List01" runat="server" style="display:none" >
            ...
            <!--    <asp:GridView ID="GVSWCList" runat="server" DataSourceID="SqlDataSource" CssClass="ADDGridView AutoNewLine" PagerStyle-CssClass="pgr"
                ...
                <div> 
            <asp:Panel ID="List02" runat="server"  style="display:none">
        ...
        <script type="text/javascript">
          //  if (document.getElementById('CHKSHTYPE').checked) { SwcArea02.style.display = ''; } else { SwcArea02.style.display = 'none'; }
        </script>
    </form>
</body>
</html>
