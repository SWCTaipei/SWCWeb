...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OnlineApply002v.aspx.cs" Inherits="SWCDOC_OnlineApply002" %>
    ...
    <div class="wrap-s">
        ...
        <div class="content-s">
            <div class="review form">
                ...
                <tr><td>暫停期限<span style="color: red;font-family:cursive;">＊</span></td>
                    <td><asp:Label ID="TXTONA002" runat="server"></asp:Label> ~
                        <asp:Label ID="TXTONA003" runat="server"></asp:Label></td></tr>
                <tr><td>暫停審查理由<span style="color: red;font-family:cursive;">＊</span></td>
                    <td><asp:Label ID="LBONA005" runat="server" Text="配合目的事業規劃調整，無法立即完成補正<br />" Visible="false"></asp:Label>
                        <asp:Label ID="LBONA006" runat="server" Text="配合其它機關重大指示事項，無法立即完成補正<br />" Visible="false"></asp:Label>
                        <asp:Label ID="LBONA007" runat="server" Text="須與土地所有權人或管理機關協調，無法立即完成補正<br />" Visible="false"></asp:Label>
                        <asp:Label ID="LBONA008" runat="server" Text="其他" Visible="false"></asp:Label>
                        <asp:Label ID="TXTONA004" runat="server" /></td></tr>
