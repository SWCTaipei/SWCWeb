<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OnlineApply003v.aspx.cs" Inherits="SWCDOC_OnlineApply003" %>
...
<body>
  ...
  <div class="content-s">
    <div class="review form">
      <h1>水土保持計畫<asp:Label ID="LBSWC004_1" runat="server" />期限展延</h1><br/><br/>
                ...
                <tr><td><asp:Label ID="LBSWC004_2" runat="server" />展延編號</td>
                ...
                <tr><td>原定<asp:Label ID="LBSWC004_3" runat="server" />期限</td>
                ...
                <tr><td>展延理由</td>
                    <td><asp:Label ID="LBONA007" runat="server" Text="尚未取得目的事業開發許可<br />" Visible="false"></asp:Label>
                        <asp:Label ID="LBONA008" runat="server" Text="尚未完成目的事業開工程序<br />" Visible="false"></asp:Label>
                        <asp:Label ID="LBONA009" runat="server" Text="尚未完成施工前置準備作業<br />" Visible="false"></asp:Label>
                        <asp:Label ID="LBONA010" runat="server" Text="其他" Visible="false"></asp:Label>
                        <asp:Label ID="TXTONA005" runat="server"/></td></tr>
                <tr><td>展延次數</td>
                    <td>第 <asp:Label ID="DDLONA004" runat="server"/>次展延</td></tr>
                ...
                <tr><td class="bgcolor bold">審查結果</td>
                    <td class="bgcolor2" style="line-height:40px;">
                        ...
                        <asp:TextBox ID="ResultsExplain" runat="server" />
