    ...
    private void LoadUpFileSwcChg()
    {
        ...
        using (SqlConnection SwcConn01 = new SqlConnection(connectionString01.ConnectionString))
        {
            ...
            while (readeCase.Read())
            {
                ...
                if (sMOVF1 != "")
                {
                    string sourceFile01 = @TempFolderPath + sDoc1 + "\\" + sMOVF1;
                ...
                if (sMOVF2 != "")
                {
                    string sourceFile02 = @TempFolderPath + sDoc1 + "\\" + sMOVF2;
                ...
                if (sMOVF3 != "")
                {
                    string sourceFile03 = @TempFolderPath+ sDoc1 + "\\" + sMOVF3;
                ...
                if (sMOVF4 != "")
                {
                    string sourceFile04 = @TempFolderPath + sDoc1 + "\\" + sMOVF4;
                ...
                if (sMOVF5 != "")
                {
                    string sourceFile05 = @TempFolderPath + sDoc1 + "\\" + sMOVF5;
                ...
                if (sMOVF6 != "")
                {
                    string sourceFile06 = @TempFolderPath + sDoc1 + "\\" + sMOVF6;
                ...
                if (sMOVF7 != "")
                {
                    string sourceFile07 = @TempFolderPath + sDoc1 + "\\" + sMOVF7;
                ...
                if (sMOVF8 != "")
                {
                    string sourceFile08 = @TempFolderPath + sDoc1 + "\\" + sMOVF8;
