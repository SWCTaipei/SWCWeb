    ...
    private void LoadUpFileSwcChg()
    {
        ...
        using (SqlConnection SwcConn01 = new SqlConnection(connectionString01.ConnectionString))
        {
            ...
            while (readeCase.Read())
            {
                ...
                if (sMOVF1 != "")
                {
                    string destinationFile01 = @TempFolderPath + sDoc1 + "\\" + sMOVF1;
                    string sourceFile01  = @"D:\Web\SWCWeb\UpLoadFiles\SwcCaseFile\" + sDoc2 + "\\" + sMOVF1;

                    if (System.IO.File.Exists(sourceFile01))
                    {
                        if (System.IO.File.Exists(destinationFile01)) { }
                        else
                        {
                ...
                if (sMOVF2 != "")
                {
                    string destinationFile02 = @TempFolderPath + sDoc1 + "\\" + sMOVF2;
                    string sourceFile02  = @"D:\Web\SWCWeb\UpLoadFiles\SwcCaseFile\" + sDoc2 + "\\" + sMOVF2;

                    if (System.IO.File.Exists(sourceFile02))
                    {
                        if (System.IO.File.Exists(destinationFile02)) { }
                        else
                        {
                            // To move a file or folder to a new location:
                ...
                if (sMOVF3 != "")
                {
                    string destinationFile03 = @TempFolderPath + sDoc1 + "\\" + sMOVF3;
                    string sourceFile03 = @"D:\Web\SWCWeb\UpLoadFiles\SwcCaseFile\" + sDoc2 + "\\" + sMOVF3;

                    if (System.IO.File.Exists(sourceFile03))
                    {
                        if (System.IO.File.Exists(destinationFile03)) { }
                        else
                        {
                        // To move a file or folder to a new location:
                ...
                if (sMOVF4 != "")
                {
                    string destinationFile04 = @TempFolderPath + sDoc1 + "\\" + sMOVF4;
                    string sourceFile04  = @"D:\Web\SWCWeb\UpLoadFiles\SwcCaseFile\" + sDoc2 + "\\" + sMOVF4;

                    if (System.IO.File.Exists(sourceFile04))
                    {
                        if (System.IO.File.Exists(destinationFile04)) { }
                        else
                        {
							// To move a file or folder to a new location:
                ...
                if (sMOVF5 != "")
                {
                    string destinationFile05 = @TempFolderPath + sDoc1 + "\\" + sMOVF5;
                    string sourceFile05  = @"D:\Web\SWCWeb\UpLoadFiles\SwcCaseFile\" + sDoc2 + "\\" + sMOVF5;

                    if (System.IO.File.Exists(sourceFile05))
                    {
                        if (System.IO.File.Exists(destinationFile05)) { }
                        else
                        {
							// To move a file or folder to a new location:
                ...
                if (sMOVF6 != "")
                {
                    string destinationFile06 = @TempFolderPath + sDoc1 + "\\" + sMOVF6;
                    string sourceFile06  = @"D:\Web\SWCWeb\UpLoadFiles\SwcCaseFile\" + sDoc2 + "\\" + sMOVF6;

                    if (System.IO.File.Exists(sourceFile06))
                    {
                        if (System.IO.File.Exists(destinationFile06)) { }
                        else
                        {
							// To move a file or folder to a new location:
                ...
                if (sMOVF7 != "")
                {
                    string destinationFile07 = @TempFolderPath + sDoc1 + "\\" + sMOVF7;
                    string sourceFile07  = @"D:\Web\SWCWeb\UpLoadFiles\SwcCaseFile\" + sDoc2 + "\\" + sMOVF7;

                    if (System.IO.File.Exists(sourceFile07))
                    {
                        if (System.IO.File.Exists(destinationFile07)) { }
                        else
                        {
                        // To move a file or folder to a new location:
                ...
                if (sMOVF8 != "")
                {
                    string destinationFile08 = @TempFolderPath + sDoc1 + "\\" + sMOVF8;
                    string sourceFile08  = @"D:\Web\SWCWeb\UpLoadFiles\SwcCaseFile\" + sDoc2 + "\\" + sMOVF8;

                    if (System.IO.File.Exists(sourceFile08))
                    {
                        if (System.IO.File.Exists(destinationFile08)) { }
                        else
                        {
							// To move a file or folder to a new location:
