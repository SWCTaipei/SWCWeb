...
public partial class SWCDOC_SWCDT007 : System.Web.UI.Page
{
    ...
    private void Data2Page(string v, string v2)
    {
        ...
        using (SqlConnection SwcConn = new SqlConnection(connectionString.ConnectionString))
        {
            ...
            else
            {
                ...
                strSQLRV2 = strSQLRV2 + "   where DTLG000 = '" + v2 + "' ";
                ...
                while (readeDTL.Read())
                {
                    ...
                    //點擊放大圖片類處理
                    string[] arrayFileName0 = new string[] { tDTLG060 };
                    System.Web.UI.WebControls.HyperLink[] arrayImgAppobj0 = new System.Web.UI.WebControls.HyperLink[] { HyperLink060 };
    ...
    private string Get07SWC000(string v2)
    {
        string _returnVall = "";
        string strSQLRV = " select SWC000 from SWCDTL07 ";
        strSQLRV = strSQLRV + " where DTLG000 = '" + v2 + "' ";
    ...
    protected void GenerateDropDownList()
    {
        ...
        string[] array_DTL042 = new string[] { "", "無明顯龜裂", "有無明顯龜裂" };
    ...
    protected void SaveCase_Click(object sender, EventArgs e)
    {
        ...
        using (SqlConnection SwcConn = new SqlConnection(connectionString.ConnectionString))
        {
            ...
            sEXESQLSTR = sEXESQLSTR + " DTLG003 ='" + sDTLG003 + "', ";
            ...
            Response.Write("<script>alert('資料已存檔'); location.href='SWCDT007.aspx?SWCNO=" + sSWC000 + "&DTLNO=" + sDTLG000 + "'; </script>");
        }
    }
    ...
    {
        string vCaseID = Request.QueryString["SWCNO"] + "";
        Response.Redirect("SwcDtl07.aspx?SSS=Y");
    }
