...
public partial class SWCDOC_SWCDT003 : System.Web.UI.Page
{
    ...
    protected void SaveCase_Click(object sender, EventArgs e)
    {
        ...
        using (SqlConnection SwcConn = new SqlConnection(connectionString.ConnectionString))
        {
            ...
            Response.Write("<script>alert('資料已存檔'); location.href='SWCDT003.aspx?SWCNO=" + sSWC000 + "&DTLNO=" + sDTLC000 + "'; </script>");
    ...
    private void UpLoadTempFileMoveChk(string CaseId)
    {
        ...
        string[] arryUpLoadField = new string[] { "TXTDTL056" };
        TextBox[] arryUpLoadAppoj = new TextBox[] { TXTDTL056 };
    ...
    {
        string vCaseID = Request.QueryString["SWCNO"] + "";
        Response.Redirect("SwcDtl03.aspx?SSS=Y");
    }
